<!DOCTYPE html>
<html lang="en"> 
<!--colors: green: #99bbad, beige: #ebd8b7, pink #c6a9a3, purple: #9a8194 !-->
<head>
	<meta charset="utf-8">
	<meta name="keywords" content="restaurant, food, drinks,  milwaukee, wisconsin">
    <meta name="author" content="Danielle Leslie">
    
    
     <!--title & media responsiveness-->
    <title>The Inn | Dining &amp; Drinks - Milwaukee, WI</title>
    ...
    <link rel="stylesheet" href="/css/redocontact.css">
...
<body>
	<header>
        <div class="header">
            <a href="../index.html" class="logo"><img src="../images/theinnlogo.png" alt=CompanyLogo width="150" height="150"></a>
            <br>
            <br>
            <br>
           <div class="header-right">
            ...
            <a href="redocontact.html">Contact</a>
		...
		<fieldset>
			...
			<a href="redocontact.html"><input type="submit" id="buttons2" value="Return to Contact Form"></a></div></fieldset></section></section>
...
?>
      ...
      <footer>
       <div id="socialsleft"><a href="https://www.facebook.com"><img id="socialsleft" src="../images/socials/facebook.png" class="logo" alt="facebook" width="40" height="40"></a>
        <a href="https://www.youtube.com"><img id="socialsleft" src="../images/socials/youtube.png" class="logo" alt="youtube" width="40" height="40"></a></div>
        <p id="pcopyright">&copy; The Inn Restaurant &amp; Bar |  2021 - Milwaukee, WI</p>
                   <div id="socialsright"><a href="https://www.instagram.com"><img id="socialsright" src="../images/socials/instagram.png" class="logo" alt="instagram" width="40" height="40"></a>
                    <a href="https://www.linkedin.com"><img id="socialsright" src="../images/socials/linkedin.png" class="logo" alt="linkedin" width="40" height="40"></a></div>
	</footer>
</html>